...
export class PomoSettingTab extends PluginSettingTab {
    ...
    display(): void {
        ...
        if (this.plugin.settings.logging === true) {
            ...
            new Setting(containerEl)
                .setName("Log to note (Custom Session Default)")
                .setDesc("Default setting for custom sessions: Log to a specific note")
                .addToggle(toggle => toggle
            ...
            if (this.plugin.settings.logToNote) {
                new Setting(containerEl)
                    .setName("Log note (Custom Session Default)")
                    .setDesc("Default note for custom sessions")
                    .addText(text => text
